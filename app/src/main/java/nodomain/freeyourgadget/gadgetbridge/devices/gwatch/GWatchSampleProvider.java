...
public class GWatchSampleProvider extends AbstractSampleProvider<BangleJSActivitySample> {
    private static final Logger LOG = LoggerFactory.getLogger(GWatchSampleProvider.class);

    public GWatchSampleProvider(GBDevice device, DaoSession session) {
