...
public class GWatchAppsManagementActivity extends AbstractGBActivity {
    private static final Logger LOG = LoggerFactory.getLogger(GWatchAppsManagementActivity.class);
    ...
    public GWatchAppsManagementActivity() {
    }
    ...
    protected void onResume() {
        ...
        commandFilter.addAction(GWatchDeviceSupport.GWATCH_COMMAND_RX);
    ...
    BroadcastReceiver deviceUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            switch (intent.getAction()) {
                case GWatchDeviceSupport.GWATCH_COMMAND_RX: {
    ...
    public void bangleTxData(String data) {
        Intent intent = new Intent(GWatchDeviceSupport.GWATCH_COMMAND_TX);
    ...
    private void initViews() {
        ...
        GBWebClient gbWebClient = new GBWebClient(InternetRequestType.BANGLE_APP_LOADER, mGBDevice){
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                Toast.makeText(GWatchAppsManagementActivity.this, "Error:" + description, Toast.LENGTH_SHORT).show();
